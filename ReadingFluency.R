##########################################
######Reading Fluency Analysis Script#####
######Author: Stephanie###################
######Updated: Oct 02 2017################
##########################################
...
setwd("/Volumes/PEGASUS/Projects/Admin/NSF_SLCN/")   #Other users will need to change this to their directory
my.data <- read.csv(file = "readingFluency.csv",header=TRUE)
...
t1scores <- my.data %>% filter(Wave==1)
...
write.csv(master.data,file = "ReadingFluency_ForAnalysis.csv",na="")
